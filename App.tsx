      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="container mx-auto px-4 lg:px-8 h-20 flex items-center justify-between">
          ...
          >
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 leading-none">مجمع هنا الطبي</h1>
              <span className="text-xs text-primary-600 font-medium tracking-wider">HMC</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button 
              ...
              className="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2.5 rounded-full font-medium transition shadow-lg shadow-primary-500/20"
            >
              حجز موعد
            </button>
          </div>
        ...
        {/* Mobile Menu Overlay */}
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b border-gray-100 p-4 absolute w-full flex flex-col gap-2 shadow-xl animate-in slide-in-from-top-5">
            {NAV_LINKS.map(link => (
              <NavItem 
                key={link.id}
                id={link.id}
      ...
      <main className="flex-1">
        ...
        {currentView === 'HOME' && (
          <div className="animate-in fade-in duration-500">
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-br from-primary-50 to-white py-20 lg:py-28">
              ...
              <div className="container mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10">
                <div className="space-y-6 text-center lg:text-right">
                  <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm border border-primary-100 text-primary-700 text-sm font-medium animate-in slide-in-from-bottom-3 fade-in duration-700">
                    <Star size={16} className="fill-current" />
                    أفضل رعاية طبية في المنطقة
                  </div>
                  <h1 className="text-4xl lg:text-6xl font-black text-gray-900 leading-tight">
                    رعايتكم.. <span className="text-primary-600">أمانتنا</span>
                    <br />
                    وصحتكم أولويتنا
                  </h1>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                    <button 
                      onClick={() => handleNavClick('DOCTORS', false)}
                      className="bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-xl shadow-primary-500/30 transition-all hover:-translate-y-1 flex items-center justify-center gap-2"
                    >
                      <Calendar size={20} />
                      احجز موعد الآن
                    </button>
                    <button 
                      ...
                      className="bg-white hover:bg-gray-50 text-gray-800 border-2 border-gray-100 px-8 py-4 rounded-xl font-bold text-lg transition-all hover:-translate-y-1 flex items-center justify-center gap-2"
                    >
                      <Phone size={20} />
                      تواصل معنا
                    </button>
                ...
                <div className="relative animate-in slide-in-from-left-10 duration-1000">
                  ...
                  {/* Floating Card */}
                  <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-50 hidden lg:block animate-bounce [animation-duration:3s]">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-gray-900">١٠,٠٠٠ مريض</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section className="py-20 bg-white">
              <div className="container mx-auto px-4 lg:px-8">
                <div className="text-center mb-16">
                  <h2 className="text-3xl font-bold text-gray-900 mb-4">الأقسام الطبية</h2>
                  <p className="text-gray-600 max-w-2xl mx-auto">نقدم مجموعة واسعة من الخدمات الطبية المتخصصة بأعلى معايير الجودة</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {DEPARTMENTS.map((dept, idx) => (
                    <div 
                      ...
                      className="group p-8 rounded-3xl bg-gray-50 hover:bg-primary-50 border border-gray-100 hover:border-primary-100 transition-all duration-300 cursor-pointer"
                    >
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-primary-700 transition-colors">{dept.title}</h3>
                      <p className="text-gray-600 leading-relaxed">{dept.desc}</p>
                      <div className="mt-4 flex items-center gap-2 text-primary-600 font-bold text-sm opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all">
        ...
        {(currentView === 'DOCTORS' || currentView === 'HOME') && (
          <section id="doctors" className={`py-20 ${currentView === 'HOME' ? 'bg-gray-50' : 'bg-white pt-10'}`}>
            <div className="container mx-auto px-4 lg:px-8">
              {currentView === 'HOME' && (
                <div className="flex justify-between items-end mb-12">
                   <div>
                      <h2 className="text-3xl font-bold text-gray-900 mb-2">نخبة الأطباء</h2>
                      <p className="text-gray-600">اختر طبيبك واحجز موعدك بكل سهولة</p>
                   </div>
                   <button 
                      onClick={() => handleNavClick('DOCTORS', false)}
                      className="hidden md:flex items-center gap-2 text-primary-600 font-bold hover:text-primary-700 transition"
                   >
              ...
              {currentView === 'DOCTORS' && (
                <div className="mb-12">
                   <div className="text-center mb-8 animate-in fade-in slide-in-from-top-4">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">قائمة الأطباء</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto">فريق طبي متكامل من أفضل الاستشاريين والأخصائيين جاهز لخدمتكم</p>
                  </div>
                  
                  {/* Filter Status */}
                  {selectedSpecialty && (
                    <div className="flex flex-col items-center gap-4 animate-in zoom-in-95">
                      <div className="flex items-center gap-3 bg-primary-50 px-6 py-3 rounded-full border border-primary-100">
                        <Filter size={18} className="text-primary-600" />
                        <span className="text-gray-700">تصفح: <span className="font-bold text-primary-700">{selectedSpecialty}</span></span>
                        <button 
                          onClick={() => setSelectedSpecialty(null)}
                          className="mr-2 bg-white rounded-full p-1 hover:bg-gray-100 text-gray-500 transition"
                          title="إلغاء التصنيف"
                        >
                          <X size={14} />
                        </button>
              ...
              {displayedDoctors.length > 0 ? (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {displayedDoctors.map((doctor, idx) => (
                    <div 
                      key={doctor.id} 
                      className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-xl hover:border-primary-100 transition-all duration-300 group animate-in zoom-in-50"
                    ...
                    >
                      ...
                      <div className="space-y-3 mb-6">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          ...
                          <span>أقرب موعد: <span className="font-semibold text-gray-900">{doctor.availability[0]}</span></span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          <div className="font-bold text-gray-900">{doctor.price} جنيه</div>
                      ...
                      <button 
                        ...
                        className="w-full py-3 rounded-xl bg-gray-50 text-gray-900 font-bold hover:bg-primary-600 hover:text-white transition-all duration-300 border border-gray-200 hover:border-transparent"
                      >
                        حجز موعد
                      </button>
                    </div>
                ...
                <div className="grid md:grid-cols-2">
                   ...
                   <div className="p-12 bg-white">
                      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                         <h3 className="text-xl font-bold text-gray-900 mb-4">أرسل لنا رسالة</h3>
                         <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">الاسم</label>
                            <input type="text" className="w-full px-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-500 outline-none" placeholder="الاسم الكريم" />
                         </div>
                         <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">البريد الإلكتروني</label>
                            <input type="email" className="w-full px-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-500 outline-none" placeholder="example@email.com" />
                         </div>
                         <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">الرسالة</label>
                            <textarea rows={4} className="w-full px-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-primary-500 outline-none" placeholder="كيف يمكننا مساعدتك؟"></textarea>
                         </div>
                         <button className="w-full bg-gray-900 text-white font-bold py-3 rounded-xl hover:bg-gray-800 transition">
                            إرسال الرسالة
                         </button>
                      </form>
                   </div>
